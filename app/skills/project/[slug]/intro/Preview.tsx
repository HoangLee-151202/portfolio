...
export default function PreviewIntroProject () {
  ...
  return (
    <div className="mx-auto w-full space-y-4">
      <motion.div initial={{ opacity: 0, x: "-5rem" }}
            animate={{ opacity: 1, x: 0 }}
            transition={{ duration: 0.8, ease: "easeOut" }} className="flex items-center gap-x-4 mb-6">
      <DialogClose asChild>
      <Button
            variant="ghost"
            size="icon"
