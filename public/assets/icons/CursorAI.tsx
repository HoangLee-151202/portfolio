...
export function CursorAI(props: SVGProps<SVGSVGElement>) {
  return (
    <svg fill="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" {...props}>
      <g clip-path="url(#prefix__clip0_5_17)">
        <rect width="512" height="512" rx="122" fill="#currentColor" />
